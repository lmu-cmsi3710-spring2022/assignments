...
To ensure that the four filter aren’t solely simplistic derivatives of the samples, make sure to do one of the following:
...
| Neighborhood filters | 20 points total | _1a_, _2c_, _3b_, _4a_–_4d_ |
